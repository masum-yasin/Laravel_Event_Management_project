            ...
            <ul id="accordion-menu">
                <li class="dropdown">
                    ...
                    <a href="javascript:;" class="dropdown-toggle">
                        <span class="micon dw dw-copy"></span><span class="mtext">Event Type Product</span>
                    </a>
                    <ul class="submenu">
                        <li><a href="{{route('category.index')}}">All product Event</a></li>
                ...
                <li class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle">
                        <span class="micon dw dw-copy"></span><span class="mtext">Employee Event</span>
                    </a>
                    <ul class="submenu">
                        <li><a href="{{route('evantcategories.index')}}">All Employee Category Event</a></li>
                        <li><a href="{{route('evantcategories.create')}}">New Employee Add</a></li>
